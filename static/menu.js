...
menutoggle.onclick = function(event) {
	...
	var el = document.querySelectorAll("#nav a.submenu, #nav ul.submenu");
...
forEach(document.querySelectorAll("#nav a.submenu"), function (index, value) {
...
function hideMenu() {
	var el = document.querySelectorAll("#menutoggle, #menutoggle + ul, #nav a.submenu, #nav ul.submenu");
	var i; for (i = 0; i < el.length; i++) {
		el[i].classList.remove(activeClass);
	}
}
